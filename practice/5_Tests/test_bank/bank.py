...
def value(greeting):
    if (
        greeting[0:5].lower() == "hello"
    ):  # This is a string splice to get the first 5 letters in the response
        return 0
    elif (
        greeting[0:1].lower() == "h"
    ):  # This is a string splice to get the first letter in the response
        return 20
    else:
        return 100
